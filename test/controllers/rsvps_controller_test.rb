...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { comment: @rsvp.comment, email: @rsvp.email, guest: @rsvp.guest, plusone: @rsvp.plusone }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { comment: @rsvp.comment, email: @rsvp.email, guest: @rsvp.guest, plusone: @rsvp.plusone }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
